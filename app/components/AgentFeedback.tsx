...
import { analyst, interviewer } from '@/constants';
import { createFeedback, getFeedbackByInterviewId, getInterviewById } from '@/lib/actions/general.action';
...
const Agent = ({ userName, userId, type, interviewId, feedback }: AgentProps) => {
    ...
    if (type === "generate") {
      ...
      await vapi.start(interviewer, {
        ...
        const intId = await interviewId;
        const user = await getCurrentUser();
        
        const interview = await getInterviewById(intId!);
        ...
        await vapi.start(analyst, {
            variableValues: {
            feedback: feedbackScript,
            },
        });
    }
  }; 
    ...
    const handleDisconnect = async () => {
        ...
        toast.success('Thanks for the call, redirecting you to the feedback page.')
        router.push(`/interview/${interviewId}/feedback`)
        vapi.stop();
    } 
            ...
            <div className='call-view'>
                <div className='card-border-interviewer'>
                  <div className='card-interviewer gap-0!'>
                      ...
                      <h3 className='text-black!'>Feedback Analyst</h3>
                  </div>
                </div>

                <div className='card-border'>
                    <div className='card-content '>
                        <Image src="/user-avatar.png" alt="user avatar" width={540} height={540} className='rounded-full object-cover size-[120px] p-5 bg-[#333333]!' />
            ...
            <div className='w-full flex justify-center py-2'>
                {callStatus != 'ACTIVE' ? (
                    <button className='relative btn-call' onClick={handleCall}>
                        ...
                        <span>
                            {isCallInactiveOtFinished ? 'Start Feedback Session' : '. . .'}
                        </span>
                    </button>
                ) : (
